...
class CommonJob(BaseModel):
    """
    Common data sanitization job configurations
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["columnScoringFunction", "driver", "executor", "isFullyDistributed", "input", "idAttributes", "informationLossMeasures", "output", "partitions", "partitionFunction", "quasiIdAttributes", "redact", "samplingFraction", "repartitionFunction"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CommonJob from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CommonJob from a dict"""
        if obj is None:
            return None
