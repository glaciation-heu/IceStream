...
class LDiversityJob(BaseModel):
    """
    Configuration of the l-diversity data sanitization job
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["columnScoringFunction", "driver", "executor", "isFullyDistributed", "input", "idAttributes", "informationLossMeasures", "output", "partitions", "partitionFunction", "quasiIdAttributes", "redact", "samplingFraction", "repartitionFunction", "l", "sensitiveAttributes"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LDiversityJob from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of LDiversityJob from a dict"""
        if obj is None:
            return None
