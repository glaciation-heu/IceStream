...
class SparkPodSpec(BaseModel):
    """
    Common customizations for a Spark driver or executor pod
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SparkPodSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SparkPodSpec from a dict"""
        if obj is None:
            return None
