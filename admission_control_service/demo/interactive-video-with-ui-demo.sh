...
pe 'POLICY=../policy-library/library/general/allowedrepos/'
pe 'kubectl create -f $POLICY/template.yaml'
wait # show constraint template in the web UI

print_section_title '\n[*] Add constraint'
pe 'kubectl create -f $POLICY/samples/repo-must-be-openpolicyagent/constraint.yaml'
wait # show constraint in the web UI

PROMPT_TIMEOUT=5

print_section_title '\n[*] Test'
print_and_create_resource 'Deploy pod with Open Policy Agent container' '$POLICY/samples/repo-must-be-openpolicyagent/example_allowed.yaml'
wait # explain test
print_and_create_resource 'Deploy pod with NGINX container' '$POLICY/samples/repo-must-be-openpolicyagent/example_disallowed_container.yaml'
wait # explain test
print_and_create_resource 'Deploy pod with NGINX init container and Open Policy Agent container' '$POLICY/samples/repo-must-be-openpolicyagent/example_disallowed_initcontainer.yaml'
wait # explain test
print_and_create_resource 'Deploy pod with NGINX init container and NGINX container' '$POLICY/samples/repo-must-be-openpolicyagent/example_disallowed_both.yaml'
wait # explain test

print_section_title '\n[*] Test clean-up'
pe 'kubectl delete -f $POLICY/samples/repo-must-be-openpolicyagent/example_allowed.yaml'
pe 'kubectl delete -f $POLICY/samples/repo-must-be-openpolicyagent/example_disallowed_container.yaml'
pe 'kubectl delete -f $POLICY/samples/repo-must-be-openpolicyagent/example_disallowed_initcontainer.yaml'
pe 'kubectl delete -f $POLICY/samples/repo-must-be-openpolicyagent/example_disallowed_both.yaml'
pe 'kubectl delete -f $POLICY/samples/repo-must-be-openpolicyagent/constraint.yaml'
pe 'kubectl delete -f $POLICY/template.yaml'
